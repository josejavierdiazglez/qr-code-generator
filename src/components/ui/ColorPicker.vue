...
<template>
  <PopoverRoot>
    <PopoverTrigger
      class="flex h-10 w-full items-center gap-2 rounded-lg border border-border bg-input px-2.5 text-sm transition-colors hover:border-primary/40 focus-visible:border-ring focus-visible:outline-none"
    ...
    <PopoverPortal>
      ...
      >
        ...
        <div class="mt-3 flex items-center gap-2">
          ...
          <input
            :value="modelValue"
            class="h-8 w-full rounded-md border border-border bg-input px-2 font-mono text-xs focus-visible:border-ring focus-visible:outline-none"
            spellcheck="false"
